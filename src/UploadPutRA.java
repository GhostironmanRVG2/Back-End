...
import connector.UploadPutRAimp;

public class UploadPutRA extends HttpServlet {
	String name_photo;
    int s=1;
    String ext;
	...
	public void doPut(HttpServletRequest request, HttpServletResponse response)  
		...
		String id_request=request.getParameter("id_request");
		int id=Integer.parseInt(id_request);
		...
		//FILE UPLOAD
		try {
				MultipartRequest m=new MultipartRequest(request,"C:/Users/pedro/Desktop/Projeto/Projeto/Back-end/WebContent/IMAGES/",1000000*512);
		...
		R.setId_request(id);
		R.setPhoto(name_photo);
		UploadPutRAimp fu=new UploadPutRAimp();
