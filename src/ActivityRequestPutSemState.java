...
import connector.ActivityRequestPutSemStateIMP;
import models.Request_Activity;

public class ActivityRequestPutSemState extends HttpServlet {
	...
	protected void doPut(HttpServletRequest req,HttpServletResponse resp)
			throws ServletException,IOException{
		     ...
		     Time time=Time.valueOf(t);
		      ...
		      //Connector 
		      ActivityRequestPutSemStateIMP AR=new ActivityRequestPutSemStateIMP();  
			   int i=AR.Put(R);
				if(i>0) {
					doGet(req,resp,200);
